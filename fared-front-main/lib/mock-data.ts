...
export const MOCK_CLOTHES_PRODUCTS = [
  { id: 'luna-meditation-robe', name: 'Luna Meditation Robe', price: 88.0, image: 'luna-meditation-robe.webp', colors: ['#9B59B6', '#2980B9', '#95A5A6', '#E91E8C'] },
  { id: 'sol-yoga-top', name: 'Sol Yoga Top', price: 64.0, image: 'sol-yoga-top.webp', colors: ['#F5F0E8', '#27AE60', '#95A5A6'] },
  { id: 'gaia-flow-pants', name: 'Gaia Flow Pants', price: 72.0, image: 'gaia-flow-pants.webp', colors: ['#8B6347', '#6B4C3B', '#27AE60', '#556B2F'] },
  { id: 'nova-energy-shirt', name: 'Nova Energy Shirt', price: 68.0, image: 'nova-energy-shirt.webp', colors: ['#1A237E', '#37474F', '#546E7A'] },
  { id: 'aurora-wrap-dress', name: 'Aurora Wrap Dress', price: 96.0, image: 'luna-meditation-robe.webp', colors: ['#C0392B', '#8E44AD', '#F39C12'] },
  { id: 'zenith-linen-set', name: 'Zenith Linen Set', price: 120.0, image: 'sol-yoga-top.webp', colors: ['#F5F0E8', '#D4C5A9', '#A0856C'] },
  { id: 'lotus-kimono', name: 'Lotus Kimono', price: 110.0, image: 'gaia-flow-pants.webp', colors: ['#FECB7D', '#E8A87C', '#C9A84C'] },
  { id: 'solstice-pants', name: 'Solstice Pants', price: 78.0, image: 'nova-energy-shirt.webp', colors: ['#2C3E50', '#34495E', '#7F8C8D'] },
]
...
export const MOCK_CLOTHES: ClothingItem[] = [
  { id: 'cloth-001', name: 'Mystic Robe', nameFA: 'ردای عارفانه', slug: 'mystic-robe', price: 89, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#4a1060','#1a0a2e','#2d1b6b'] },
  { id: 'cloth-002', name: 'Moon Dress', nameFA: 'لباس ماه', slug: 'moon-dress', price: 76, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#c8a951','#f5f0e8','#2d1b6b'] },
  { id: 'cloth-003', name: 'Shadow Kimono', nameFA: 'کیمونوی سایه', slug: 'shadow-kimono', price: 94, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#1a0a2e','#0d0520','#4a2580'] },
  { id: 'cloth-004', name: 'Crystal Wrap', nameFA: 'شال کریستال', slug: 'crystal-wrap', price: 58, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#7fdccb','#b8a4e8','#f5f0e8'] },
  { id: 'cloth-005', name: 'Eclipse Coat', nameFA: 'کت اکلیپس', slug: 'eclipse-coat', price: 112, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#0d0520','#1a0a2e','#c8a951'] },
  { id: 'cloth-006', name: 'Celestial Top', nameFA: 'تاپ آسمانی', slug: 'celestial-top', price: 45, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#4a2580','#b8a4e8','#2d1b6b'] },
  { id: 'cloth-007', name: 'Ritual Pants', nameFA: 'شلوار مراسم', slug: 'ritual-pants', price: 67, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#1a2e1a','#0a0f0a','#7fdccb'] },
  { id: 'cloth-008', name: 'Aura Vest', nameFA: 'جلیقه اورا', slug: 'aura-vest', price: 52, image: '/images/products/clothes/luna-meditation-robe.webp', images: [], colors: ['#c8a951','#4a1060','#1a0a2e'] },
]
...
export const MOCK_MENTORS: Mentor[] = [
  {
    ...
    sessionPrice: 85, currency: 'USD', sessionDuration: '60 min',
  ...
  },
  {
    ...
    sessionPrice: 75, currency: 'USD', sessionDuration: '60 min',
  ...
  },
  {
    ...
    sessionPrice: 90, currency: 'USD', sessionDuration: '75 min',
