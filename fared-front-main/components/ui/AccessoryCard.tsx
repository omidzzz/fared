...
export default function AccessoryCard({ accessory }: AccessoryCardProps) {
  ...
  return (
    <Link href={`/product/${accessory.id}`} style={{ textDecoration: 'none', display: 'block' }}>
      <div
        style={{
          position: 'relative',
          borderRadius: '16px',
      ...
      >
        ...
        <div style={{ borderRadius: '16px', overflow: 'hidden', position: 'relative', flex: '1 1 60%' }}>
          <Image
            src={accessory.image}
            alt={accessory.name}
            fill
          ...
          <div style={{
            ...
            background: 'linear-gradient(to top, #1a140a 0%, transparent 100%)',
          }} />
        </div>
