  ...
  return (
    <div className="relative overflow-hidden" style={{ minHeight: '100svh' }}>
      ...
      <div className="min-h-full flex flex-col pt-[80px] pb-4 px-4 sm:px-8">
        ...
        <div className="relative overflow-hidden rounded-2xl">
          ...
          <div className="text-center py-4 relative z-20" dir="rtl">
            ...
            <div className="flex items-center justify-center gap-3">
              <div className="h-px w-16 sm:w-24" style={{ background: 'rgba(254,203,125,0.40)' }} />
              <svg width="20" height="10" viewBox="0 0 20 10" fill="none">
                <path d="M0 5 Q5 0 10 5 Q15 10 20 5" stroke="#FECB7D" strokeWidth="0.8" fill="none" opacity="0.7"/>
              </svg>
              <p className="font-farsi text-sm text-[var(--text-secondary)]">اندیشه، دانش و الهام</p>
              <svg width="20" height="10" viewBox="0 0 20 10" fill="none">
        ...
        <div className="flex flex-col gap-3 flex-1 min-h-0 sm:grid sm:grid-cols-2 pb-6">
          {SECTIONS.map((section) => (
            <Link key={section.id} href={section.href} className="block">
              <div
                className="relative rounded-2xl overflow-hidden border border-white/[0.08] active:scale-[0.98] transition-all duration-200 sm:h-full"
                style={{ height: '160px' }}
              >
                {/* Full-bleed image */}
                <Image
                ...
                >
                  <p className="font-farsi font-bold text-sm text-[var(--text-primary)]">
                    {section.icon} {section.titleFA}
                  </p>
                  <p className="font-farsi text-xs mt-0.5" style={{ color: section.accent }}>
                    {section.ctaFA}
                  </p>
                </div>
              </div>
        ...
        <div className="text-center py-3" dir="rtl">
          <div className="flex items-center justify-center gap-3">
            ...
            <p
              className="font-farsi text-[var(--text-muted)]"
