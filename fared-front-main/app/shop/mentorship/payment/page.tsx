...
export default function PaymentPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0514', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, overflowY: 'auto', height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 40px' }}>
